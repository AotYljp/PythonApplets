...
while True:
    ...
    examurl = 'http://219.216.96.104:8090/index.php' ##'http://222.200.98.165:8090/index.php'
    loginurl = 'http://219.216.96.104:8090/exam_login.php' ##'http://222.200.98.165:8090/exam_login.php'
    ...
    enterurl = 'http://219.216.96.104:8090/redir.php?catalog_id=6'
    headers = {
        'Connection': 'keep-alive',
        'Host': '219.216.96.104:8090',
        'Referer': 'http://219.216.96.104:8090/index.php',
    ...
    kaoshiurl = 'http://219.216.96.104:8090/redir.php?catalog_id=6&cmd=kaoshi_chushih&kaoshih=17206&kqcl=1' ## 校级'http://219.216.96.104:8090/redir.php?catalog_id=6&cmd=kaoshi_chushih&kaoshih=317797'
    #kaoshiurl = 'http://219.216.96.104:8090/redir.php?catalog_id=6&cmd=kaoshi_chushih&kaoshih=17864&moshi=lianxi'
    #kaoshiurl = 'http://219.216.96.104:8090/redir.php?catalog_id=6&cmd=kaoshi_chushih&kaoshih=17864&kqcl=1'#kqcl=1
    headers = {
        'Connection': 'keep-alive',
        'Host': '219.216.96.104:8090',
        'Referer': 'http://219.216.96.104:8090/redir.php?catalog_id=6',
        'Upgrade-Insecure-Requests': '1',
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36i/537.36'
    }
    ...
    answer = open('answer22.txt')
    answer = answer.read()

    datiurl = 'http://219.216.96.104:8090/redir.php?catalog_id=6&cmd=dati'
    headers = {
        'Host': '219.216.96.104:8090',
        'Origin': 'http://219.216.96.104:8090',
        'Referer': 'http://219.216.96.104:8090/redir.php?catalog_id=6&cmd=dati',
        'Upgrade-Insecure-Requests': '1',
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36'
    }
